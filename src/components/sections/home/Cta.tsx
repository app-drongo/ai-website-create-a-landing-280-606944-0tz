...
export default function Cta() {
  ...
  const stats = [
    { value: '25K+', label: 'Active Teams', icon: Users },
    { value: '99.9%', label: 'Uptime SLA', icon: Shield },
    { value: '300+', label: 'Integrations', icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Streamline workflows, automate processes, and boost team productivity by 40%. The
                all-in-one platform that grows with your business needs.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              <div className="size-12 mx-auto rounded-full bg-accent/20 flex items-center justify-center mb-3">
                <div className="size-6 rounded-full bg-accent" />
              </div>
              <h3 className="font-semibold">Risk-Free Trial</h3>
              <p className="text-sm text-muted-foreground">14 days free access, cancel anytime</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Deploy in under 30 minutes with guided onboarding
              </p>
            </div>
          </div>
        </div>
